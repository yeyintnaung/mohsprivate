                    ...
                    <div class="card-body">
                        <div class="d-flex no-block">
                            ...
                            <div class="m-l-10 align-self-center">
                                <h3 class="m-b-0">{{$typetwocounts}}</h3>
                                <h5 class="text-muted m-b-0">Type Two Patients</h5></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex no-block">
                            ...
                            <div class="m-l-10 align-self-center">
                                ...
                                <h5 class="text-muted m-b-0">Type One Patients</h5></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex no-block">
                            ...
                            <div class="m-l-10 align-self-center">
                                <h3 class="m-b-0">{{$usercounts}}</h3>
                                <h5 class="text-muted m-b-0">Registered Admins</h5></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex no-block">
                            ...
                            <div class="m-l-10 align-self-center">
                                <h3 class="m-b-0">{{$unsubmittedadmins}}</h3>
                                <h5 class="text-muted m-b-0">Unsubmitted Admins</h5></div>
                        </div>
                    </div>
                </div>
            </div>
