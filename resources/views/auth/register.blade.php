        ...
        <div class="login-box card">
            <div class="card-body">
                ...
                <form class="form-horizontal form-material" method="POST" id="loginform" action="{{ route('register') }}">
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" required="" name='email' value="{{old('email')}}" placeholder="Email" required> </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            Do U have account? <a href="{{url('login')}}" class="text-info m-l-5"><b>Login</b></a>
                        </div>
                    </div>
                </form>
