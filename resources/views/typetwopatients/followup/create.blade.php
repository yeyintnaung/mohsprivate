...
@section('content')
    ...
    <!-- ============================================================== -->
        ...
        <div class="page-wrapper">
            <!-- ============================================================== -->
            @if(\App\Models\TypeTwoPatients::all()->count()==0)
               <h1 class="text-center">NO Patient</h1>
                @else
                                    ...
                                    <div class="card-body">
                                        <div class="row pt-3">
                                            <div class="col-md-6">
                                                @if($link_patient_id =='')
                                                    <div class="form-group">
                                                        ...
                                                        <select name='patient_id' v-model="getid"
                                                            ...
                                                            @if(old('patient_id'))
                                                                ...
                                                                <option
                                                                    ...
                                                                    selected>{{old('patient_id')}}</option>
                                                            @else
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                @else
                                                    <getdatabyid-component :initial_id="{{$id[0]->id}}"
                                                                           ref="fromchild"></getdatabyid-component>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="weight" v-model="weight"
                                                           @change="onweightchangelister" @keyup="onweightchangelister"
                                                           class="form-control"
                                                           id=""
                                                           placeholder="Weight"/>
                                            ...
                                            <div class="col-md-6">
                                                @if($errors->has('hba1c'))
                                                    <dateorno-component oldvalue="{{old('hba1c')}}"
                                                                        title='HbA1C(last date)' fieldname="hba1c"
                                        ...
                                        <div class="row pt-3">
                                            <div class="col-md-6">
                                                @if($errors->has('ph_hypertension'))
                                                    <dateorno-component oldvalue="{{old('ph_hypertension')}}"
                                                                        title='Hypertension' fieldname="ph_hypertension"
                                            ...
                                            <div class="col-md-6">
                                                @if($errors->has('ph_dyslipidaemia'))
                                                    <dateorno-component oldvalue="{{old('ph_dyslipidaemia')}}"
                                                                        title='Dyslipidaemia'
                                        ...
                                        <div class="row pt-3">
                                            <div class="col-md-6">
                                                @if($errors->has('ph_tuberculosis'))
                                                    <dateorno-component oldvalue="{{old('ph_tuberculosis')}}"
                                                                        title='Tuberculosis' fieldname="ph_tuberculosis"
                                            ...
                                            <div class="col-md-6">
                                                @if($errors->has('ph_stroke'))
                                                    <dateorno-component oldvalue="{{old('ph_stroke')}}" title='Stroke'
                                                                        fieldname="ph_stroke"
                                        ...
                                        <div class="row pt-3">
                                            <div class="col-md-6">
                                                @if($errors->has('ihd_mi'))
                                                    <dateorno-component oldvalue="{{old('ph_ihd_mi')}}" title='IHD/MI'
                                                                        fieldname="ph_ihd_mi"
                                            ...
                                            <div class="col-md-6">
                                                @if($errors->has('ph_nephropathy'))
                                                    <dateorno-component oldvalue="{{old('ph_nephropathy')}}"
                                                                        title='Nephropathy' fieldname="ph_nephropathy"
