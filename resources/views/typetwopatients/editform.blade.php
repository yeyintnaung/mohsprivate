                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="age" value="{{old('age',$data->age)}}"
                                                           class="form-control"
                                                           id=""
                                                           placeholder="age"/>
                                                    @error('age')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        <div class="row no-gutters">
                                                            ...
                                                            @elseif(old('gender',$data->gender)=='female')
                                                                <div class="col-xs-4 mr-5">
                                                                    <input type="radio" id="customRadio11"
                                                                           name="gender" value='male'
                                                                           class="form-check-input"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control form-select"
                                                            ...
                                                            name="referred_from"
                                                            value="{{old('referred_from',$data->referred_form)}}" tabindex="1">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" v-model="height" name="height" value=""
                                                           ...
                                                           id=""
                                                           placeholder="height"/>
                                                    @if(!empty(old('height',$data->height) ))

                                                        <script>
                                                            var oldheight ={!! json_encode(old('height',$data->height)) !!}
                                                        </script>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" v-model="weight" name="weight" value=""
                                                           ...
                                                           id=""
                                                           placeholder="Weight"/>
                                                    @if(!empty(old('weight',$data->weight) and !empty($data->weight)))

                                                        <script>
                                                            var oldweight ={!! json_encode(old('weight',$data->weight)) !!}
                                                        </script>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="hba1c" value="{{old('hba1c',$data->hba1c)}}"
                                                           class="form-control"
                                                           id=""
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="">OAD</label>
                                                    <input type="text" name="oad" value="{{old('oad',$data->oad)}}"
                                                           class="form-control"
                                                           id=""
                                                           placeholder="OAD"/>
                                                    @error('oad')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        <div class="row no-gutters">
                                                            <div class="col-xs-4 mr-5">
                                                                @php
                                                                    if(old('naive',$data->naive)=='yes'){
        $surgical_historyy='checked';
        $surgical_historyn='';

                                                                            }elseif(old('naive',$data->naive)=='no'){
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="dyslipidaemia"
                                                           value="{{old('dyslipidaemia',$data->dyslipidaemia)}}"
                                                           id=""
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="tuberculosis"
                                                           value="{{old('tuberculosis',$data->tuberculosis)}}"
                                                           id=""
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="nephropathy"
                                                           value="{{old('nephropathy',$data->nephropathy)}}"
                                                           id=""
